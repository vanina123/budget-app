...
ActiveRecord::Schema[7.0].define(version: 2023_08_14_111326) do
  ...
  create_table "records", force: :cascade do |t|
    ...
    t.index ["expenditure_id"], name: "index_records_on_expenditure_id"
  end
  ...
  add_foreign_key "records", "expenditures"
end
