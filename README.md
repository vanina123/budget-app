...
**My Budget**  is a web app anyone who wants to get control of their finances. It is easy to use and can help you to save money, avoid debt, and reach your financial goals.
...
- [ ] **Adding categories**
- [ ] **Adding Expenditure based on the category**
- [ ] **Including dates of categories and expenditures**
- [ ] **Linking expenditure to any number of categories**
...
```sh
  git https://github.com/vanina123/bugdet-app.git
  cd budget-app
```
...
- [ ] **Make the budget app more responsive**
- [ ] **Implement the Menu nad search button**
- [ ] **Add more styling**
